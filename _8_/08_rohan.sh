...
mkdir /scratch/${USER}_${PROJ}/_8_

## Set permissions for directory
chmod 700 /scratch/${USER}_${PROJ}/_8_

##  Copy input files to scratch
# cp /home/$USER/$PROJ/input/* /scratch/${USER}_${PROJ}/

## cd into working scratch directory
cd /scratch/${USER}_${PROJ}/_8_
...
gunzip -c /scratch/aubaxh002_02_read_mapping/_8_/hifiasm_kangaroo_rat_6cells.p_ctg.fasta.gz > \
/scratch/aubaxh002_02_read_mapping/_8_/hifiasm_kangaroo_rat_6cells.p_ctg.fasta

samtools faidx /scratch/aubaxh002_02_read_mapping/_8_/hifiasm_kangaroo_rat_6cells.p_ctg.fasta

while read -a line
	do
	samtools sort -n -@ 9 \
	-o querysorted_${line[0]}_small_genome_rgroups.bam \
	/scratch/aubaxh002_02_read_mapping/_8_/sorted_${line[0]}_small_genome_rgroups.bam 
	
	samtools fixmate -r -m -O BAM -@ 9 \
	--reference /scratch/aubaxh002_02_read_mapping/_8_/hifiasm_kangaroo_rat_6cells.p_ctg.fasta.gz \
	...
	done < /home/aubaxh002/sample_lists/_8_.txt
...
mail -s 'ROHan _8_ finished' avrilharder@gmail.com <<< 'ROHan _8_ finished'