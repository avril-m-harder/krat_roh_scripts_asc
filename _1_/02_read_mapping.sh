...
# while read -a line
# do
# cat /scratch/aubaxh002_01_read_qc_trimming/_1_/trimmed_paired_${line[0]}_L003_R1_001.fastq.gz \
...
# cat /scratch/aubaxh002_01_read_qc_trimming/_1_/trimmed_paired_${line[0]}_L003_R2_001.fastq.gz \
