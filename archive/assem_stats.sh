...
cp /home/aubaxh002/02_read_mapping/input/hifiasm_kangaroo_rat_6cells.p_ctg.fasta.gz .
...
cp hifiasm_kangaroo_rat_6cells.p_ctg.fasta.fai /home/$USER/$PROJ/output/
