...
/scratch/aubaxh002_01_read_qc_trimming/_5_/trimmed_paired_${line[0]}_L003_R1_001.fastq.gz \
/scratch/aubaxh002_01_read_qc_trimming/_5_/trimmed_paired_${line[0]}_L003_R2_001.fastq.gz \
> ${line[0]}_L003_small_genome.bam

bwa mem -t 20 -M /scratch/aubaxh002_02_read_mapping/hifiasm_kangaroo_rat_6cells.p_ctg.fasta.gz \
/scratch/aubaxh002_01_read_qc_trimming/_5_/trimmed_paired_${line[0]}_L004_R1_001.fastq.gz \
/scratch/aubaxh002_01_read_qc_trimming/_5_/trimmed_paired_${line[0]}_L004_R2_001.fastq.gz \
