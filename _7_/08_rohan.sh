...
gunzip -c /scratch/aubaxh002_02_read_mapping/_7_/hifiasm_kangaroo_rat_6cells.p_ctg.fasta.gz > \
/scratch/aubaxh002_02_read_mapping/_7_/hifiasm_kangaroo_rat_6cells.p_ctg.fasta

samtools faidx /scratch/aubaxh002_02_read_mapping/_7_/hifiasm_kangaroo_rat_6cells.p_ctg.fasta

while read -a line
	do
	samtools sort -n -@ 9 \
	-o querysorted_${line[0]}_small_genome_rgroups.bam \
	/scratch/aubaxh002_02_read_mapping/_7_/sorted_${line[0]}_small_genome_rgroups.bam 
	
	samtools fixmate -r -m -O BAM -@ 9 \
	--reference /scratch/aubaxh002_02_read_mapping/_7_/hifiasm_kangaroo_rat_6cells.p_ctg.fasta.gz \
...
mail -s 'ROHan _7_ finished' avrilharder@gmail.com <<< 'ROHan _7_ finished'